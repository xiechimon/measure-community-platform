...
> **历史骨架设计。** 本文第 9 节中“时间银行/商城/健康档案/安防/支付等一期外”的范围结论，已由[后端需求基线设计](2026-07-17-backend-requirements-baseline-design.md)替代；本文第 10 节的端到端验证结论已由 `docs/ROADMAP.md` 的后续验证状态替代。本文仅作为 2026-07-16 的工程骨架决策参考，不作为当前范围或完成状态依据。
